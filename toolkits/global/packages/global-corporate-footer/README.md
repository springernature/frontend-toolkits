...
@use '@springernature/global-corporate-footer/scss/10-settings/default';
@use '@springernature/global-corporate-footer/scss/10-settings/springer';
@use '@springernature/global-corporate-footer/scss/10-settings/nature';

// Include this with your other components
@use '@springernature/global-corporate-footer/scss/50-components/corporate-footer';
```
