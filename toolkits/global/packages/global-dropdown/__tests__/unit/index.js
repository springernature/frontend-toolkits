...
beforeEach( () => {
	document.body.innerHTML = "<div class=\"c-dropdown\">\n" +
		...
		"\t\t<li class=\"c-dropdown__menu-button\"><a data-dropdown-item download href=\"prongles.mp3\"><span class=\"u-visually-hidden\">Download</span> file 1</a></li>\n" +
		"\t\t<li class=\"c-dropdown__menu-button\"><a data-dropdown-item download href=\"orinocoflow.mp3\"><span class=\"u-visually-hidden\">Download</span> file 2</a></li>\n" +
		"\t\t<li class=\"c-dropdown__menu-button\"><a data-dropdown-item download href=\"somefile.mp3\"><span class=\"u-visually-hidden\">Download</span> file 3</a></li>\n" +
		"\t</ul>\n" +
		"</div>\n";
	init();
});
