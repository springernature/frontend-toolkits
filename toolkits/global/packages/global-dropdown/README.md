...
@use '@springernature/global-dropdown/scss/10-settings/default';
@use '@springernature/global-dropdown/scss/10-settings/nature';

// Include this with your other components
@use '@springernature/global-dropdown/scss/50-components/dropdown';
```
